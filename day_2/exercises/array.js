...
// Declare a variable that will store an array of at least 3 foods (strings)
var foods = ["pizza", "mac'n'cheese", "cookies"];
console.log(foods);
...
console.log(animals.find(element => element == "Zebra"));
